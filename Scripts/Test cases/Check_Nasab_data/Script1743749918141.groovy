...
WebUI.callTestCase(findTestCase('Test cases/Login_to_Jomaih'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Object Repository/Page_/input__reference'), 'new maraj')
